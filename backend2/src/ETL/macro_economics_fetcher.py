"""
FRED Macro Economics Data Fetcher
Single file to fetch ALL historical data for macro economic indicators.
...
Run: python macro_economics_fetcher.py
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('macro_economics_fetcher.log', encoding='utf-8'),
        logging.StreamHandler()
    ]
)
logger = logging.getLogger(__name__)

class MacroEconomicsFetcher:
    """Fetches all historical macro economics data from FRED."""
    ...
    def __init__(self):
        ...
        # Macro Economics Indicators Configuration - Your 6 indicators
        self.indicators = {
            'gdp_growth_rate': {
                'series_id': 'GDPC1',
            ...
            'unemployment_rate': {
                ...
                'start_date': '1948-01-01',  # Historical start
                'frequency': 'Monthly',
                'unit': 'Percent',
            ...
            'nonfarm_payrolls': {
                ...
                'start_date': '1939-01-01',  # Historical start
                'frequency': 'Monthly',
            ...
            'consumer_confidence': {
                ...
                'start_date': '1978-01-01',  # Historical start
                'frequency': 'Monthly',
            ...
            'retail_sales': {
                ...
                'start_date': '1992-01-01',  # Historical start
                'frequency': 'Monthly',
        ...
        # Setup collection
        self.collection_name = 'macro_economics'
    ...
    def fetch_all_indicators(self) -> bool:
        """Fetch all macro economics indicators."""
        logger.info("🚀 Starting FRED Macro Economics Data Fetch")
...
def main():
    """Main entry point."""
    try:
        fetcher = MacroEconomicsFetcher()
        success = fetcher.fetch_all_indicators()
        
        if success:
            print("\n🎉 All macro economics data fetched successfully!")
